    ...
    <div className="Home">
      ...
      <Row style={{marginTop: "50px"}}>
        <Col style={{textAlign: "left"}} flex={3}>
          ...
          <br />
          <h3>How it Works</h3>
          <p>To receive a report of what tweets are flagged from our undisputed list of “bad” words from your Twitter account create an account and set up a new search by inputting your Twitter handle and any additional words you would like our product to search for. From there, we will use our list and any additional words you provided to make a comprehensive list of tweets that we suggest you delete from your account to make sure your Twitter account is promoting a safe space as well. Yes, it’s that easy, and it’s completely free.</p>
          </div>
          </Col>
